...
async def upload_process(files: List[UploadFile] = File(...)):
    try:
        ...
        output_folder = split_pdf_folder(temp_folder)
        folder_to_minio(output_folder, bucket_name)
...
# Define other functions (split_pdf_folder, upload_to_minio, index_file_content_to_es, etc.) here
...
# Usage example
# folder_name = r'C:\Users\Admin\Desktop\eTest\attachments'
